...
class MainMenu
{
  public void menu()
  {
        System.out.println(" You are in employee data base");
       System.out.println("\nPress\n1 -- To Enter an Employee\n2 : To See an Employee Details\n3 : To Remove an Employee details from data base\n4 : To Update Employee Details\n5 : To Exit from the EMS Portal");
  }
}
    ...
    public void createFile()
    {
        ...
        try{
            ...
            if(f1.createNewFile()){
                ...
                myWriter.close();
                System.out.println("\nEmployee has been Added Successfully to the data base :)\n");
